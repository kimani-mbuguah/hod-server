...
//POST /member/creategroup
router.post(
	"/creategroup",
	authCheck([Roles.member, Roles.admin, Roles.superAdmin]),
	memberController.createCustomGroup
);
...
//POST /member/customgroupsms
router.post(
	"/customgroupsms",
	authCheck([Roles.member, Roles.admin, Roles.superAdmin]),
	memberController.sendCustomGroupSMS
);
...
//GET /member/getgroups
router.get(
	"/getgroups",
	authCheck([Roles.member, Roles.admin, Roles.superAdmin]),
	memberController.getCustomGroups
);
